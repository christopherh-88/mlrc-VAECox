...
os.system('python vae_main.py -mt vae -ol mRNA@ -hn 4096 -lr 0.001 -dr 0 -wd 1e-5 -dv cpu -cd 0 -sn vae_pretrained -fc None -mx 50 -af Tanh -mo Adam -bs 0 -vd toyforVAE -sm')
